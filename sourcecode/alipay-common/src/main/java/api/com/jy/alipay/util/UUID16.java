...
//			for (int i = 0; i < 30; i++) {
//				UUID16 uuid = create();
//                System.err.println("aaaaa-----" + uuid.toString().length());
//			}
//
//			long end = System.currentTimeMillis();
//            System.err.println("total=" + (end - begin) + "ms," + (end - begin) / 1000L + " second");
...
//            System.out.println( new String(addr,"ISO-8859-1"));
//            System.out.println( new String(addr,"GB2312"));
//            System.out.println( new String(addr,"utf-8"));
//            System.out.println( new String(addr,"gbk"));
